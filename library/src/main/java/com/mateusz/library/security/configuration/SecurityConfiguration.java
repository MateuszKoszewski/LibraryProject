package com.mateusz.library.security.configuration;
...
//    @Autowired
//    public SecurityConfiguration(JWTAuthorizationFilter jwtAuthorizationFilter, JwtAccessDeniedHandler jwtAccessDeniedHandler, JwtAuthenticationEntryPoint jwtAuthenticationEntryPoint, UserService userDetailsService, BCryptPasswordEncoder bCryptPasswordEncoder) {
